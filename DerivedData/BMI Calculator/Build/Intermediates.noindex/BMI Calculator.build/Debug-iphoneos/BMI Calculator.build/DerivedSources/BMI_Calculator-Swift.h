...
SWIFT_CLASS("_TtC14BMI_Calculator23CalculateViewController")
...
- (IBAction)weightSliderChanged:(UISlider * _Nonnull)sender;
- (IBAction)calculatePressed:(UIButton * _Nonnull)sender;
...
SWIFT_CLASS("_TtC14BMI_Calculator20ResultViewController")
@interface ResultViewController : UIViewController
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified bmiValueLabel;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified adviceLabel;
- (void)viewDidLoad;
- (IBAction)recalculatePressed:(UIButton * _Nonnull)sender;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC14BMI_Calculator13SceneDelegate")
